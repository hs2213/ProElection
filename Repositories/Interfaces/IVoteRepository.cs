...
public interface IVoteRepository
{
    ...
    public Task<bool> CheckIfUserVotedInElectionAsync(Guid userId, Guid electionId);
    ...
    public Task<int> GetCandidateVotesByElectionIdAsync(Guid candidateId, Guid electionId);
}